...
class Mobil extends Kendaraan{
    ...
    public function setKapasitaMesin($kapasitasMesin){
        $this->kapasitasMesin = $kapasitasMesin;
    }
    public function getKapasitaMesin(){
